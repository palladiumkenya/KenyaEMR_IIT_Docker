...
def prep_locational_features(targets_df, mfl, dhs, txcurr):
    ...
    loc_for_inference = loc_for_inference[['sitecode', 'rolling_weighted_noshow', 
                                           'rolling_weighted_dayslate', 'txcurr', 
                                           'kephlevel', 'facilitytypecategory', 
                                           'ownertype', 'men_knowledge', 'women_knowledge',
