...
def run_retraining_pipeline(aws = True, start_date = str, end_date = str, refresh_date = str):
    ...
    # read in targets0521.parquet from s3
    targets = pd.read_parquet('s3://kehmisjan2025/targets0521.parquet')
    # read in visits0521.parquet from s3
    visits = pd.read_parquet('s3://kehmisjan2025/visits0521.parquet')
    # read in pharmacy0521.parquet from s3
    pharmacy = pd.read_parquet('s3://kehmisjan2025/pharmacy0521.parquet')
    # read in lab0521.parquet from s3
    lab = pd.read_parquet('s3://kehmisjan2025/lab0521.parquet')
    import gc
    gc.collect()
